...
if((_vehicle != player) && (playerSide == west)) then {
    if((typeof _vehicle == "B_Heli_Light_01_F" || typeof _vehicle == "O_Heli_Light_02_unarmed_F" || typeof _vehicle == "I_Heli_light_03_unarmed_F") && (_vehicle getVariable ["nano_emp_enabled", false])) then {
